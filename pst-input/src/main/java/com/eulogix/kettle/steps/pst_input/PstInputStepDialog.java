 ...
 */
public class PstInputStepDialog extends EasyStepDialog {

    // this is the object the stores the step's settings
    // the dialog reads the settings from it when opening
    // the dialog writes the settings to it when confirmed
    private PstInputStepMeta meta;
     ...
     */
    public PstInputStepDialog(Shell parent, Object in, TransMeta transMeta, String sname) {
        super(parent, (BaseStepMeta) in, transMeta, sname);
        meta = (PstInputStepMeta) in;
        PKG = PstInputStepMeta.class;
        messagesPrefix = "PstInputStep";
    }
    ...
    public String open() {
        ...
        shell.setText(BaseMessages.getString(PKG, "EulogixPstInputStep.Shell.Title"));
        ...
        for (Map.Entry<String, Object> entry : meta.fields.entrySet()) {
            switch (entry.getKey()) {
                default:
                    lastControl = addStreamFieldSelector(entry.getKey(), lastControl);
                    break;
